export default function SwiperModule() {
  try {
    ...
    const hotelDes3 = document.querySelector(".hotel-des-3");
    if(hotelDes3){
      const hotelDes3Top = hotelDes3.querySelector(".hotel-des-3-list-img")
      ...
      const hotelDes3Bottom = hotelDes3.querySelector(".hotel-des-3-list-content");
      ...
      swiperDes3Top.controller.control = swiperRight;
      swiperRight.controller.control = swiperDes3Top;
