export default function SwiperModule() {
  try {
    ...
    if(brandLogo){
      ...
      swiperBrandLogo.on("slideChange", function () {
        var activeIndex = swiperBrandLogo.activeIndex + 1
      });
      ...
      brandLogoItems.forEach((brandLogoItem, index) => {
        ...
        brandLogoItem.addEventListener("click", (e,index) => {
          ...
          console.log(swiperBrandLogo.activeIndex + 1);
            console.log(index);
          if (
            brandLogoItemActive &&
