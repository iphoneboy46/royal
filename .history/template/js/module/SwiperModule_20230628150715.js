    ...
    if (homeBrand) {
      ...
      var swiperBrandList = new Swiper(
        homeBrandList.querySelector(".mySwiperBrandList"),
        {
          ...
          //     const itemVideos = homeBrand.querySelectorAll(".home-brand-img video");
              
          //       itemVideos[clickedIndex].play();
      ...
      const homeBrandImgItems = homeBrand.querySelectorAll(".home-brand-item-img");
      var itemVideos = homeBrand.querySelectorAll(".home-brand-img video");
    homeBrandImgItems.forEach((homeBrandImgItem)=>{
