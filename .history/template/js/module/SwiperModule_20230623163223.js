export default function SwiperModule() {
  try {
    ...
    if(dichVuList){
      ...
      var swiperBottom = new Swiper(dichVuMore.querySelector('.mySwiperBottom'), {
        speed:1200,
        slidesPerView: "auto",
        mousewheel: {
          enabled: true,
    ...
    swiperTop.params.controller.control = swiperBottom;
    swiperBottom.params.controller.control = swiperTop;
    }
