export default function SwiperModule() {
  try {
    ...
    const brandLogoAbout = document.querySelector(".brand-logo.about");
    if (brandLogoAbout) {
      var swiperBrandLogo = new Swiper(brandLogoAbout.querySelector(".mySwiperLogo"), {
        speed: 1600,
        autoplay: {
          delay: 4000,
          disableOnInteraction: false,
        ...
        pagination: {
          el: brandLogoAbout.querySelector(".swiper-pagination"),
          clickable: true,
