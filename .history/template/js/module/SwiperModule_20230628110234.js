export default function SwiperModule() {
  try {
    ...
    if(hotelDes3Right){
      const hotelDes3Top = hotelDes3Right.querySelector(".hotel-des-3-list-img")
      var swiperDes3Top = new Swiper(hotelDes3Top.querySelector(".mySwiperTop"), {
      ...
      const hotelDes3Bottom = hotelDes3Right.querySelector(".hotel-des-3-list-content");
      var swiperDes3Bottom = new Swiper(hotelDes3Bottom.querySelector(".mySwiperBottom"), {
        speed:1200,
        slidesPerView:"auto"
      });
    ...
    if(homeBrand){
      ...
      if(homeBrandContent){
        var swiperBrandContent = new Swiper(".mySwiper", {
