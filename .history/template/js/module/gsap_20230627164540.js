export default function GSAP() {
  ...
  if (homeBanner) {
    ...
    const bannerHomeWrapper = homeBanner.querySelector(".banner-home-wrapper");
    gsap.to(bannerHomeWrapper, {
      scrollTrigger: {
        trigger: bannerHomeWrapper,
        start: "top top",
        end: "bottom bottom",
        scrub: 1,
        pin: false,
    ...
    //       // toggleActions: "restart pause resume reverse", // play, pause , resume , reverse , restart , reset
    //       start: "top 50%", // "top , center , end , pixels , % , relative to top"
    //       end: "bottom 50%",
    //       scrub: 1, // thao tac scroll chuot: true , false , number
    //     },
    //     opacity: 0,
    //     duration: 5,
    //   });
