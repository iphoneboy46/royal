export default function about() {
  ...
  if(aboutList) {
    const aboutItems = aboutList.querySelectorAll(".about-list-item");
    aboutItems.forEach((aboutItem)=>{
        aboutItem.addEventListener("click",()=>{
            const aboutItemActived = aboutList.querySelector(".about-list-item.actived");
            aboutItemActived.classList.remove("actived");
